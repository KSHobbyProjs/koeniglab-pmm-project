...
if __name__=="__main__":
    ...
    utils.process_exact_eigenpairs("gaussian.Gaussian3d", Ls=Ls, k_num=4, plot_kwargs={"xlabel" : "System Length",
                                                                     "title" : "Attractive 3D Gaussian (N=32, V0=-4, R=2)"}, N=32, V0=-4, R=2)
    utils.process_exact_eigenpairs("gaussian.Gaussian3d", Ls=Ls, k_num=4, plot_kwargs={"xlabel" : "System Length",
                                                                     "title" : "Repulsive 3D Gaussian (N=32, V0=4, R=2)"}, N=32, V0=4, R=2)
    utils.process_exact_eigenpairs("gaussian.Gaussian1d", Ls=Ls, k_num=4, plot_kwargs={"xlabel" : "System Length",
    ...
    utils.process_exact_eigenpairs("ising.Ising", Ls=Ls, k_num=4, plot_kwargs={"xlabel" : "Transverse Coupling Strength",
