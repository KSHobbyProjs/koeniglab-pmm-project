...
Then, one can project the Hamiltonian onto this subspace to get a generalized eigenvalue problem $H_{\text{proj}}v' = ESv'$ where $\left(H_\text{proj}\right)$ $_{ij}$ $=\langle v_i|H|v_j\rangle$$, $S_{ij}=\langle v_i | v_j\rangle$. This assumes that all of the
